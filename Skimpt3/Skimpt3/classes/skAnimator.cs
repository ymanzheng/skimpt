...
public sealed class FormAnimator : IDisposable
{
    ...
    {        
        ...
        if (this.m_Form.MdiParent == null || this.m_Method != AnimationMethod.Blend) { 
            //Activate the form. 
            Win32.AnimateWindow(this.m_Form.Handle, this.m_Duration, (int)FormAnimator.AW_ACTIVATE | (int)this.m_Method | (int)this.m_Direction); 
        } 
    } 
    ...
    {   if (!e.Cancel) { 
            ...
            if (this.m_Form.MdiParent == null || this.m_Method != AnimationMethod.Blend) { 
                //Hide the form. 
                Win32.AnimateWindow(this.m_Form.Handle, this.m_Duration, (int)FormAnimator.AW_HIDE | (int)this.m_Method | (int)AnimationDirection.Down); 
            } 
